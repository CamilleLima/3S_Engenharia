...
def gerar_dados_relatorio(
    ...
    Args:
        ...
        imagem_extra_path (str, optional): Caminho absoluto no sistema de
            arquivos para a imagem de anexo.
    ...
    dados_proposta = {
        ...
        "cidade_uf": (
            f"{dados_cliente.get('cidade', '')}/{dados_cliente.get('estado', '')}"
        ),
        ...
        "marca_painel": resultado_dimensionamento.get("kit_solar", {}).get(
            "marca_painel", "N/A"
        ),
